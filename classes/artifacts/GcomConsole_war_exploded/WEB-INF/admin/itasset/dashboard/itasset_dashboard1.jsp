					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading" style="height: 65px;">
							...
							<ul class="options pull-right list-inline">
								...
								<li><a href="#" class="opt" title="조회" data-placement="bottom" onclick="chartReSetData()"><span class="fas fa-search" style="font-size: 22px"></span> </a></li>
							</ul>
							<!-- /right options -->
						...
						<div class="panel-body">
							<div id="flot-statistic" class="fullwidth height-250">
							</div>
						</div>
						<!-- /panel content -->
 ...
 */
		...
		var togglePlot = function(seriesIdx)
		{
		  ...
		  //plot.setupGrid();
		  //plot.draw();
		  plot = jQuery.plot(jQuery("#flot-statistic"), someData, options);
 ...
 */
			...
			if (jQuery("#flot-statistic").length > 0) {
 ...
 */
				plot = jQuery.plot(jQuery("#flot-statistic"), data, options);
			}
		...
		$(function(){
			...
			$("#flot-statistic").bind("plotclick", function (event, pos, item) {
				if (item) {
