					...
					<div id="panel-1" class="panel panel-default">
						...
						<div class="panel-footer">
							...
							<ul class="easypiecharts list-unstyled">
								<li class="clearfix">
									<span class="stat-number">20${data.totalUserCount}명</span>
									<span class="stat-title">사용자</span>

									<span class="easyPieChart" data-percent="20%${data.connectRate}" data-easing="easeOutBounce" data-barColor="#F8CB00" data-trackColor="#dddddd" data-scaleColor="#dddddd" data-size="60" data-lineWidth="4">
										<span class="percent"></span>
									</span> 
								</li>
								<li class="clearfix">
									<span class="stat-number">80${data.installRate}%</span>
									<span class="stat-title">소프트웨어 검증률</span>

									<span class="easyPieChart" data-percent="80${data.installRate}" data-easing="easeOutBounce" data-barColor="#F86C6B" data-trackColor="#dddddd" data-scaleColor="#dddddd" data-size="60" data-lineWidth="4">
										<span class="percent"></span>
									</span> 
								</li>
								<li class="clearfix">
									<span class="stat-number">5${data.commentRate}%</span>
									<span class="stat-title">비인가 소프트웨어 설치</span>

									<span class="easyPieChart" data-percent="5${data.commentRate}" data-easing="easeOutBounce" data-barColor="#98AD4E" data-trackColor="#dddddd" data-scaleColor="#dddddd" data-size="60" data-lineWidth="4">
										<span class="percent"></span>
									</span> 
								</li>
							</ul>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							...
							<div class="box danger"><!-- default, danger, warning, info, success -->
								...
								<div class="box-title"><!-- add .noborder class if box-body is removed -->
									<h4><a href="#">상용 소프트웨어 설치 사용자 : 15${data.totalUserCount}명</a></h4>
									<small class="block">불법 소프트웨어 설치 의심 :${data.connectAgentCount}4명</small>
						...
						<div class="col-md-4 col-sm-6">
							...
							<div class="box warning"><!-- default, danger, warning, info, success -->
								...
								<div class="box-title"><!-- add .noborder class if box-body is removed -->
									<h4>24개 ${data.installedAgentCount}개 소프트웨어 보유 중</h4>
									<small class="block">보유중인 상용 소프트웨어 ${data.todayInstalledCount} 10개</small>
						...
						<div class="col-md-4 col-sm-6">
							...
							<div class="box default"><!-- default, danger, warning, info, success -->
								...
								<div class="box-title"><!-- add .noborder class if box-body is removed -->
									<h4>${data.nonCommentContactCount}미검증된 소프트웨어  10개</h4>
									<small class="block">당일 탐지된 미검증 소프트웨어 ${data.todayContactCount}4개 </small>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div id="panel-2" class="panel panel-default">
								<div class="panel-heading">
									<span class="title elipsis">
										<strong><i class="fa fa-question-circle" aria-hidden="true"></i>&nbsp;&nbsp;소프트웨어 설치 현황</strong> <!-- panel title -->
									</span>
								</div>

								<!-- panel content -->
								<div class="panel-body">
								<canvas class="chart-container" id="myPieChart"  style="position: relative; height:60vh; width:80vw"></canvas>
								</div>
								<!-- /panel content -->
							</div>
							<!-- /PANEL -->
						...
						<div class="col-md-6">
							...
							<div id="panel-3" class="panel panel-default">
								...
								<div class="panel-heading">
									<span class="title elipsis">
										<strong><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;&nbsp;소프트웨어 감사</strong> <!-- panel title -->
									</span>
								</div>
