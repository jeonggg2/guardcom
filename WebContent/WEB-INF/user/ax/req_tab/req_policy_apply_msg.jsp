...
<table class="table table-bordered table-td-middle" id="msg_block_table" style="width:100%; margin-top: 20px;"">
	...
	<thead>
		<tr>
			...
			<td class="center-cell vertical-middle">대화 내용 로그 기록</td>
			<td class="center-cell vertical-middle">대화 차단</td>
			<td class="center-cell vertical-middle">파일 전송 로그 기록</td>
			<td class="center-cell vertical-middle">파일 전송 차단</td>
		</tr>
	</thead>
	<tbody>
	</tbody>
