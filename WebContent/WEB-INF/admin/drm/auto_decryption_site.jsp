...
<html lang="utf-8">
	...
	<body>
		...
		<div id="wrapper" class="clearfix">
			...
			<% request.setAttribute("menu_sub_first", 10200); %> 
							...
							<div id="panel-list" class="panel panel-default">
								...
								<div class="panel-heading">
									<span class="title elipsis">
										<strong>자동 복호화를 수행할 사이트 목록 (암호화된 파일을 복호화 절차 없이 파일을 업로드 할 사이트를 등록하시기 바랍니다)</strong> <!-- panel title -->
									</span>
								</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-12" style="overflow: auto;">
											<button type="button" id="btnRegProcess" class="btn btn-sm btn-green pull-right" onclick="javascript:fn_open_reg_process_popup(0);"><i class="fa fa-check"></i>사이트 등록</button>
		...
		<script type="text/javascript">
			...
			function fn_open_reg_process_popup(code){
				...
				$.ajax({      
				    type:"GET",  
				    url:'${context}/admin/drm/autodecsite/register',
				    async: false,
				    data:{ 
				    	code : code,
				    	_ : $.now()
			...
			function delete_data(code){
				...
				$.ajax({      
				    type:"POST",  
				    url:'${context}/admin/drm/autodecsite/unregister',
				    async: false,
				    data:{ 
				    	data :code,
				    	_ : $.now()
				...
				loadScript(plugin_path + "datatables/extensions/Buttons/js/buttons.jqueryui.min.js", function(){
					...
					if (jQuery().dataTable) {
						...
						table.dataTable({
							...
							"ajax" : {
							"url":'${context}/admin/drm/autodecsite',
						   	"type":'POST',
						   	"dataSrc" : "data",
						   	"data" :  {},
					        "beforeSend" : function(){
