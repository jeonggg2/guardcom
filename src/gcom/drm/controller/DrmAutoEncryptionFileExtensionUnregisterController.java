...
@WebServlet("/admin/drm/autoencfileext/unregister")
public class DrmAutoEncryptionFileExtensionUnregisterController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DrmAutoEncryptionFileExtensionUnregisterController() {
        super();
