...
@WebServlet("/admin/drm/autodecsite/register")
public class DrmAutoDecryptionSiteRegisterController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DrmAutoDecryptionSiteRegisterController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	request.setAttribute("Title", "자동 복호화 사이트 등록");
    	request.setAttribute("Name", "사이트 주소");
    	request.setAttribute("RegisterUrl", "/admin/drm/autodecsite/register");
