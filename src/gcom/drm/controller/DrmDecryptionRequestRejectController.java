...
@WebServlet("/admin/drm/decreq/reject")
public class DrmDecryptionRequestRejectController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DrmDecryptionRequestRejectController() {
        super();
