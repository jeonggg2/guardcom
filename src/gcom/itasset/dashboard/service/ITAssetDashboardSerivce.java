package gcom.itasset.dashboard.service;
...
import gcom.itasset.dashboard.dao.ITAssetDashboardDao;
...
public class ITAssetDashboardSerivce {
	
	public ITAssetStatisticModel getStatisticData(Map<String, Object> map){
		ITAssetDashboardDao dao = new ITAssetDashboardDao(); 
		return dao.getStatisticData(map);
	}
