...
@WebServlet("/ax/user/policy/process/list")
public class axUserPolicyProcessListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axUserPolicyProcessListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		map.put("prsId", request.getParameter("code").toString());
