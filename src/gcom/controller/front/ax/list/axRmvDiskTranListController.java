...
@WebServlet("/ax/rmvdisktran/list")
public class axRmvDiskTranListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axRmvDiskTranListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Object> data = action.getRmvDiskFileLogList(map);
