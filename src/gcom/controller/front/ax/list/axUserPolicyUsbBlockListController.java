...
@WebServlet("/ax/user/policy/usbblock/list")
public class axUserPolicyUsbBlockListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axUserPolicyUsbBlockListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		map.put("usbId", request.getParameter("code").toString());
