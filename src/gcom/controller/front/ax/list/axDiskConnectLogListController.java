...
@WebServlet("/ax/diskconnect/list")
public class axDiskConnectLogListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axDiskConnectLogListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Object> data = action.getDiskConnectLogList(map);
