...
@WebServlet("/ax/user/policy/network/list")
public class axUserPolicyNetWorkListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axUserPolicyNetWorkListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		map.put("netId", request.getParameter("code").toString());
