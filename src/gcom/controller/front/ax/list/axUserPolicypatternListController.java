...
@WebServlet("/ax/user/policy/pattern/list")
public class axUserPolicypatternListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axUserPolicypatternListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		map.put("patId", request.getParameter("code").toString());
