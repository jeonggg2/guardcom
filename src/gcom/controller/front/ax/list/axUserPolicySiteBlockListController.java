...
@WebServlet("/ax/user/policy/website/list")
public class axUserPolicySiteBlockListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axUserPolicySiteBlockListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		map.put("siteId", request.getParameter("code").toString());
