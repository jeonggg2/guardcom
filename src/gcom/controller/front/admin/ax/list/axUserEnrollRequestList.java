...
@WebServlet("/ax/userenroll/list")
public class axUserEnrollRequestList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axUserEnrollRequestList() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		map.put("user_permit", request.getParameter("user_permit").toString());
		map.put("user_phone", request.getParameter("user_phone").toString());
		...
		HashMap<String, Object> data = action.getEnrollRequestList(map);
